...
#The margins can eb incredibly small! Here there can't be more than a couple of pixels difference between the prediction and the GT label for the dart in the 5 segment. 
![alt text](images/d2_fail.JPG)