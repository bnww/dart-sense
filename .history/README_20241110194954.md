...
2. Configure your game settings. **Important: replace Webcam IP with the IP shown when you start your IP Webcam server.** ![app set up screen](images/set_up_screen.png)
