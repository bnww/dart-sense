...
class GUI:
    ...
    def save_data(self):
        ...
        image_path = os.path.join(dir, 'dartsense_'+ new_num + '.jpg')
        cv2.imwrite(image_path, self.img)
        
        label_path = os.path.join(dir.replace('images', 'labels'), 'dartsense_'+ new_num + '.txt')
        label = ""
