...
class GUI:
    ...
    def launch(self):
        ...
        # radio buttons for testing mode vs demo mode
        self.mode = StringVar(self.menu_frame, "demo")
        ttk.Label(self.menu_frame, text="Mode:").grid(column=1, row=7, sticky=W)
        test_mode_button = ttk.Radiobutton(self.menu_frame, text='Test', variable=self.mode, value='test')
        demo_mode_button = ttk.Radiobutton(self.menu_frame, text='Demo', variable=self.mode, value='demo')
        test_mode_button.grid(column=2, row=7, sticky=W)
        demo_mode_button.grid(column=2, row=8, sticky=W)
