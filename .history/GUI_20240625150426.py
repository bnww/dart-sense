...
class GUI:
    ...
    def _game_screen(self):
        ...
        self.visit_labels = []
        for i in range(3):
            font = font.Font(family='Helvetica', size=12, weight='bold', color=self.dart_colours[i])
            visit_label = ttk.Label(self.mainframe, font=font)
    ...
    def update_scoreboard(self, score, remaining, fps):
        darts = [dart for dart in self.video_processing.darts_in_visit]
