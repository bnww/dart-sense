...
class GUI:
    ...
    def _game_screen(self):
        ...
        s.configure('Visit_1', font=('Helvetica', 12), foreground=self.dart_colours[0])
        ...
        for i in range(3):
            ...
            visit_label = ttk.Label(self.mainframe, font=self.current_player_font, style=f'Visit_{i}'+str(i)
