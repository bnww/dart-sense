...
class GUI:
    ...
    def _game_screen(self):
        ...
        transform_button.grid(column=6, row=5, sticky=W)
        live_button.grid(column=6, row=6, sticky=W)
        ...
        add_button = ttk.Button(self.mainframe, text="Add dart", underlinecommand=lambda: self.video_processing.dart_coords_in_visit.append([0.5, 0.5]) if len(self.video_processing.dart_coords_in_visit) < 3 else None)
        ...
        # add button for showing keyboard shortcuts
        shortcuts_button = ttk.Button(self.mainframe, text="Keyboard shortcuts", command=self.show_keyboard_shortcuts)
        shortcuts_button.grid(column=6, row=3, sticky=W)
