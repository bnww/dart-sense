...
class GUI:
    ...
    def _game_screen(self):
        ...
        original_button = ttk.Radiobutton(self.mainframe, text='Original', variable=self.display_type, value='imageplane', visibility=visibility)
        transform_button = ttk.Radiobutton(self.mainframe, text='Transformed', variable=self.display_type, value='boardplane', visibility=visibility)
        live_button = ttk.Radiobutton(self.mainframe, text='Live', variable=self.display_type, value='live', visibility=visibility)
