...
2. Configure your game settings. **Important: replace Webcam IP with the IP shown when you start your IP Webcam server.** If  ![alt text](images/set_up_screen.png)
