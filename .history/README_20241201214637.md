...
After collecting the images, further pre-processing was completed to ensure that the images
were in the right form for the object detection model. All images were resized to 800x800
pixels in alignment with D1 and D2 from McNally et al. 2021. Furthermore, D3 and D4 were
sharpened using unsharp masking, as they were lower resolution, so using sharpening visually
improved the visibility of edges within the images.