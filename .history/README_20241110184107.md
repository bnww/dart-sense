...
2. Configure your game settings: **Important: replace Webcam IP with the IP shown when you start your IP Webcam server. If you don't do this correctly, ** ![alt text](image.png)
