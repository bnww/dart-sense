...
`GUI.py` is the Tkinter app. This ties closely into `video_processing` which handles the frame-by-frame predictions and ensures there are no bad predictions
