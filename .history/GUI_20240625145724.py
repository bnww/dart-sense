...
class GUI:
    ...
    def _game_screen(self):
        ...
        self.visit_labels = []
        for i in range(3):
            font = font.Font(family='Helvetica', size=10, weight='bold', color=self.dart_colours[i])
            visit_label = ttk.Label(self.mainframe, font=self.graphics_font)
            visit_label.grid(column=5, row=i+3, sticky=W)
