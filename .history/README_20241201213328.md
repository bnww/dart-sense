...
## Methodology
For this project, 2 open source data sets are used from McNally et al.
2021. This data was collected by the authors who played darts and took photos of the board
after each throw. This data consisD3, D4, and D5 were collected as additional data sets in order to provide a
