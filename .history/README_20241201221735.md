...
uses a Hough transformation to delineate the numbered segments of the board and colour analysis to differentiate between scoring beds (e.g single, double, treble). The methods for
