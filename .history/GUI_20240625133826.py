...
class GUI:
    ...
    def launch(self):
        ...
        add_player_names_button.grid(column=2, row=7, sticky=W, columnspan=2)
    ...
    def _game_screen(self):
        ...
        buttons_font = font.Font(family='Helvetica', size=10)
        ...
        original_button = ttk.Radiobutton(self.mainframe, text='Original', text_font=buttons_font, variable=self.display_type, value='imageplane')
        transform_button = ttk.Radiobutton(self.mainframe, text='Transformed', text_font=buttons_font, variable=self.display_type, value='boardplane')
        live_button = ttk.Radiobutton(self.mainframe, text='Live', text_font=buttons_font, variable=self.display_type, value='live')
        ...
        commit_button.grid(column=6, row=2, sticky=N+S+E+W)
        ...
        save_button.grid(column=6, row=3, sticky=N+S+E+W)
