...
class GUI:
    ...
    def _game_screen(self):
        ...
        self.visit_labels = []
        for i in range(3):
            s.configure(f'Visit{i}.TLabel', foreground='white', background=self.dart_colours[i])
            visit_label = ttk.Label(self.mainframe, font=self.current_player_font, style=f'Visit{i}.TLabel')
